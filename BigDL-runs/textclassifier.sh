...
${SPARK_HOME}/bin/spark-submit \
    ...
    --py-files ${PYTHON_API_ZIP_PATH},${BigDL_HOME}/textclassifier.py  \
    --jars ${BigDL_JAR_PATH} \
    --conf spark.submit.pyFiles=/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-python-api.zip \
    ...
    --conf spark.yarn.appMasterEnv.PYSPARK_PYTHON=/opt/cloudera/parcels/Anaconda/bin/python \
    --conf spark.yarn.appMasterEnv.PYSPARK_DRIVER_PYTHON=/opt/cloudera/parcels/Anaconda/bin/python \
    --conf spark.executor.extraClassPath=bigdl-${VERSION}-jar-with-dependencies.jar \
    ${BigDL_HOME}/textclassifier.py \
     --max_epoch 3 \
     --model gru
