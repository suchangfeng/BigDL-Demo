...
spark = SparkSession.builder\
  ...
  .config("spark.submit.pyFiles","/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-python-api.zip")\
  .config("spark.jars","/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-jar-with-dependencies.jar")\
  .config("spark.shuffle.reduceLocality.enabled","false")\
  .config("spark.shuffle.blockTransferService","nio")\
  .config("spark.scheduler.minRegisteredResourcesRatio","1.0")\
  .config("spark.driver.extraClassPath","/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-jar-with-dependencies.jar")\
  .config("spark.yarn.appMasterEnv.PYSPARK_PYTHON","/opt/cloudera/parcels/Anaconda/bin/python")\
  .config("spark.yarn.appMasterEnv.PYSPARK_DRIVER_PYTHON","/opt/cloudera/parcels/Anaconda/bin/python")\
  .config("spark.executor.extraClassPath","/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-jar-with-dependencies.jar")\
...
sc.addPyFile("/home/cdsw/BigDL-runs/dist/lib/bigdl-0.2.0-SNAPSHOT-python-api.zip")
